...
<!--       <div class="panel-heading">
      ...
      <div class="panel-heading">
        <i class="fa fa-comments fa-fw"></i> 코멘트
        <sec:authorize access="isAuthenticated()">
...
/*     function showList(page){
    ...
    $("#addReplyBtn").on("click", function(e){
        ...
        modal.find("input[name='replayer']").val(replayer);
  ...
  //댓글 조회 클릭 이벤트 처리 
    $(".chat").on("click", "li", function(e){
      ...
      replyService.get(rno, function(reply){
        ...
        modalInputreplayer.val(reply.replayer);
...
modalModBtn.on("click", function(e){
	...
	var originalreplayer = modalInputreplayer.val();
	
  var reply = {
		      rno:modal.data("rno"), 
		      reply: modalInputReply.val(),
		      replayer: originalreplayer};
	...
	console.log("Original replayer: " + originalreplayer);
	
	if(replayer  != originalreplayer){
...
/* 
   	...
   	modalRemoveBtn.on("click", function (e){
   	  ...
   	  replyService.remove(rno, originalreplayer, function(result){
    ...
    replayer = '<sec:authentication property="principal.username"/>';   
